...
const RepairManagementSystem = () => {
  ...
  const technicians = ['Muhammad Abdullahi Muhammad', 'Aliyu Abdu Tofa', 'Muhammad Maikaba', 'Miracle Obuna'];
    ...
    if (saved) {
      ...
      const sample = [
        ...
        },
        {
          ...
          deviceType: 'Printer',
          serialNumber: 'PR345678',
          partNumber: 'PN-003',
          issue: 'Paper jams frequently',
          status: 'Completed',
          priority: 'Low',
          ...
          adminComments: 'Replaced rollers'
        },
        {
          id: 4,
          customerName: 'David Wilson',
          deviceType: 'Tablet',
          serialNumber: 'TB901234',
          partNumber: 'PN-004',
          ...
          dateCompleted: '',
          adminComments: 'Ordered new battery'
        },
        {
          id: 5,
          customerName: 'Eva Garcia',
          deviceType: 'All-in-One PC',
          serialNumber: 'AIO567890',
          partNumber: 'PN-005',
          ...
          dateCompleted: '',
          adminComments: 'Testing graphics card'
        }
      ];
      setRepairs(sample);
                ...
                {filteredRepairs.length > 0 ? (
                  filteredRepairs.map(repair => (
                    <tr key={repair.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-sm font-mono">{repair.serialNumber}</td>
                      <td className="px-4 py-3 text-sm font-mono">{repair.partNumber}</td>
                      <td className="px-4 py-3">
                        <span className={`px-2 py-1 text-xs font-semibold rounded-full ${
                          ...
                          repair.status === 'Waiting for Parts' ? 'bg-yellow-100 text-yellow-800' :
                  ...
                  <tr>
                    <td colSpan="10" className="px-4 py-8 text-center text-gray-500">
                      No repairs found. Try adjusting your search or filters.
                    </td>
                  </tr>
                )}
              </tbody>
        ...
        <div className="bg-white rounded-lg shadow p-4">
          <div className="flex justify-between items-center text-sm text-gray-600">
            <div>
              ...
              <span className="font-semibold">{repairs.length}</span> repairs
            </div>
            <div className="flex items-center gap-4">
              <div>
                <span className="font-semibold">Total Revenue:</span> ${stats.totalRevenue.toFixed(2)}
              </div>
              <div>
                <span className="font-semibold">Avg. Repair Cost:</span> ${stats.avgCost.toFixed(2)}
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="p-6">
                <div className="flex justify-between items-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-800">
                    {editingRepair ? 'Edit Repair Order' : 'Add New Repair Order'}
                  </h2>
                  <button 
                    onClick={resetForm} 
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-4">
                      <h3 className="text-lg font-semibold text-gray-700 pb-2 border-b">Customer Information</h3>
                      <div>
                    ...
                    {/* Repair Details */}
                    <div className="space-y-4">
                      <h3 className="text-lg font-semibold text-gray-700 pb-2 border-b">Repair Details</h3>
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-1">
                          Status
                        </label>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows="3"
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="Internal notes, part orders, special instructions..."
                    />
                  </div>
                  ...
                  <div className="flex gap-3 justify-end pt-4 border-t">
                    ...
                    >
                      <Save size={20} />
                      {editingRepair ? 'Update Repair' : 'Save Repair'}
                    </button>
                  </div>
                </form>
              </div>
